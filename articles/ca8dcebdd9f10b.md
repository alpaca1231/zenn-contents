...
**「記号接地問題（Symbol Grounding Problem）」** とは、認知科学者のスティーブン・ハルナッド（Stevan Harnad）が1990年に提唱した概念で、AIは「言葉や記号（シンボル）」が「実世界の物体や概念」とどのように結びついているのか認識できないという問題です。AIは膨大なテキストデータの統計的なパターンを学習していますが、その記号は現実世界に接地していません。
